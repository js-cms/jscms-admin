  ...
  <div class="h-panel account-info-show-vue">
    <div class="h-panel-body">
      ...
      <div class="account-detail-desc">
        <p><i class="icon-clipboard"></i><span>{{account.nickname}}</span></p>
        <p><i class="icon-volume"></i><span>{{account.phone}}</span></p>
        ...
        <p><i class="icon-disc"></i><span>{{account.score}}</span></p>
      </div>
