<template>
  <div class="table-basic-vue frame-page h-panel">
    <div class="h-panel-bar">
      <span class="h-panel-title">菜单配置列表</span>
    </div>
    <div class="h-panel-body">
      <div class="common-filter-bar">
        <Row :space-x="19" :space-y="5">
          <Cell style="float: right">
            <div>
              <Button color="primary">新增菜单</Button>
            </div>
          </Cell>
        </Row>
      </div>
      <Table :loading="loading" :datas="datas">
        ...
        <TableItem prop="name" title="菜单顺序"></TableItem>
        <TableItem prop="salary" title="菜单名称"></TableItem>
        <TableItem prop="country" title="菜单别名"></TableItem>
        <TableItem prop="country" title="菜单链接"></TableItem>
