...
model.assign({
  ...
  description: { n: '描述元信息', type: 'String', f: true, t: true, r: true, extra: {comType: 'textarea'}}, //首页描述元信息
  about: { n: '关于网站', type: 'String', f: true, t: true, r: true, extra: {comType: 'textarea'}}, //关于网站
